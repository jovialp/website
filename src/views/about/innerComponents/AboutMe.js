                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div className="about-content">
                                ...
                                <div className="about-scocial"><i className="fa fa-instagram icon"></i> <a href="https://www.instagram.com/devil_of_happiness_/" target="blank">instagram.com/devil_of_happiness_</a></div>
                                <div className="about-scocial"><i className="fa fa-whatsapp icon"></i> <a href="https://api.whatsapp.com/send?phone=+918921123262" target="blank">+91-8921-123-262</a></div>
